// there can be only one topological sort for this no multiple.
...
public:
    string alienOrder(vector<string>& words) {
        ...
        // build graph adjecency list and record indegree
        for (int i = 0; i < words.size() - 1; i++) {
            ...
            for (int j = 0; j < len; j++) {
                ...
                // why this condition because we did not find next starting point
