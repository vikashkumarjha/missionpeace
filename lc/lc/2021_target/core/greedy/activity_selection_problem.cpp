/*
 *
 * Given a set of activities along with starting and finishing time of each
 * activity , find the maximum number of activities performed by the single
 * person assuming that a person can only on single activity at a time 
